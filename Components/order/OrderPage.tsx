...
const OrderManagement: FC = () => {
  ...
  const handleViewOrder = (orderId: string): void => {
    alert(`Navigate to /pages/order/view/${orderId}`);
  };
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="relative">
            <input
              ...
              className="pl-10 pr-4 py-2 bg-gray-100 rounded-lg text-sm text-gray-700 placeholder-gray-500 focus:outline-none"
            />
